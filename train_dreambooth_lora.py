...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        if class_data_root is not None:
            ...
            self.class_images_path = glob( class_data_root )
    ...
    def __getitem__(self, index):
        ...
        instance_image = dicom_pipeline( ds_dir = self.instance_images_path[index % self.num_instance_images] )[ 0 ]
        ...
        if self.class_data_root:
            ...
            class_image = dicom_pipeline( self.class_images_path[index % self.num_class_images] )

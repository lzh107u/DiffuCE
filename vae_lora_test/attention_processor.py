...
class LoRAAttnProcessor(nn.Module):
    ...
    def __call__(self, attn: Attention, hidden_states: torch.Tensor, scale: Optional[ float ] = 1.0, **kwargs) -> torch.Tensor:
        self_cls_name = self.__class__.__name__
        # 這裡註解掉
        # deprecate 會偵測當前版本後無條件報錯
        """
        deprecate(
            self_cls_name,
            "0.26.0",
        ...
        # 在這裡調整 LoRA 對 pretrained weights 的影響
